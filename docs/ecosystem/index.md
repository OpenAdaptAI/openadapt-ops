...
| [openadapt-desktop](https://github.com/OpenAdaptAI/openadapt-desktop) | **Beta** | Desktop 0.15.0 is the current Python package release. The current native installer set is `desktop-v0.14.0`: Windows MSI/NSIS, macOS arm64/x64 DMG, and Linux AppImage/DEB. It includes exact checksums, a CycloneDX SBOM, platform metadata, and build-provenance attestations. |
