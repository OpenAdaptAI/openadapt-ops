---
title: openadapt-retrieval is Research
...
# openadapt-retrieval is Research

This repository is Research. Start at [Get started](/get-started/) for the compiler path.
